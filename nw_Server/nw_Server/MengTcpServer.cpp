	...
	while (1) {
		...
		case IO_TYPE::IO_RECV:
		{
			...
			if (header.chunk_total > 1) {
				...
				//cout << "我的发我的发我的发" << endl;
				cout << "[Debug] sizeof(MengDataHeader): " << sizeof(MengDataHeader) << std::endl;
				cout << "[Debug] persent_size offset: " << offsetof(MengDataHeader, persent_size) << std::endl;
				cout << "[Debug] data_signs offset: " << offsetof(MengDataHeader, data_signs) << std::endl;
